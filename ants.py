...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            # BEGIN Problem 8
            if place.ant.can_contain(self) == True and place.ant.ant_contained == None:
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        if not gamestate.has_queen:
            ...
            return None
        # if cls.food_cost > gamestate.food or gamestate.has_queen:
        #     print('Not enough food remains to place ' + cls.__name__)
        #     return
        # else:
        #     gamestate.has_queen = True
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        if self.scare_counter != 0:
            if self.place.is_hive:
                destination = self.place
                self.scare_counter -= 1
                if self.blocked():
    ...
    def scare(self, length):
        ...
        #         else:
        #             self.destination = self.place.entrance
        #     self.scared_before = True
        if self.scared_before == False:
            self.scare_counter += length
            self.backwards = True
            self.scared_before = True
